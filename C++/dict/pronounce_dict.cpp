...
{
    string strang1(word1);
    string strang2(word2);

    std::transform(strang1.begin(), strang1.end(), strang1.begin(), ::toupper);
    std::transform(strang2.begin(), strang2.end(), strang2.begin(), ::toupper);

    if (dict.find(strang1) == dict.end() || dict.find(strang2) == dict.end()) { return false; }

    return (dict.at(strang1) == dict.at(strang2));
}
